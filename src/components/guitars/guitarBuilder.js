...
export const GuitarBuilder = () => {
  ...
  useEffect(() => {
    fetch("https://http:localhost:8088/bodyStyles")
  ...
  //Body Wood Type
  useEffect(() => {
    fetch("https://http:localhost:8088/bodyWoodTypes")
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch("https://http:localhost:8088/neckShapes")
      .then((response) => response.json())
      .then((neckShapeArray) => {
  ...
  useEffect(() => {
    fetch("https://http:localhost:8088/neckWoodTypes")
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch("https://http:localhost:8088/hardwareTypes")
      .then((response) => response.json())
      .then((hardwareArray) => {
  ...
  const handleGuitarButtonClick = (event) => {
    ...
    return fetch(`https://http:localhost:8088/customGuitars`, {
      method: "POST",
      headers: {
